...
try:
    response = rag_chain.invoke("Fais une comparaison entre les adénomes de l'hypophyse humaine et ceux observés chez d'autres espèces (animaux domestiques ou sauvages). Quelles sont les similitudes majeures ?")
    print(f"\n🤖 Hope : {response}")
